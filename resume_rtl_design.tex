...
\begin{itemize} \itemsep \isep
  ...
  \hspace*{43mm} Eclipse, MATLAB, Pytorch, Jira%, Cachegrind, CACTI, Ramulator(novice).
\end{itemize}
...
\put(0.11,-0.04){\line(1,0){3.6}}\\[-0.6cm]
\begin{itemize} \itemsep  \isep
	\item Teaching assistant - Mapping signal processing algorithms to architectures \hfill \emph{August 2019 - June 2020} \\[\spsep]
	\begin{itemize} \itemsep \isep
