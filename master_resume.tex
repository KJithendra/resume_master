...
\begin{itemize}
	...
	\emph{Synopsis VCS MX, Verdi and SpyGlass for Lint, CDC and RDC  \hfill Verilog, System Verilog, Perl, Make file, TCSH scripting, Git} \\[\spsep]
	...
	\emph{Github, Microsoft Visio  \hfill Multi markdown, UML, Pyhton, Tcsh scripting, Git} \\[\spsep]
		\begin{itemize} \itemsep \isep
	...
	\item \textbf{FPGA Desing Engineer at Indigenous 5G Testbed, IIT Madras \hfill May 2019 - June 2020} \\
	...
	\item worked on end to end VLSI design flow for Channel Decoder module like module design using HLS, verification, synthesis to place and route, testing on the Xilinx Zync FPGA.
