...
\begin{itemize}
	...
	\emph{Synopsis VCS MX, Verdi, SpyGlass for Lint, CDC and RDC  \hfill Verilog, System Verilog, Perl, Make files, Tcsh scripting, Git} \\[\spsep]
		\begin{itemize} \itemsep \isep
			...
			\item Enabled Parameterization in the Punit Repository to make it a central repository from which multiple Punits, with different features, can be generated.
