...
\begin{itemize}\itemsep \isep
	\item Attended Indian Mobile Congress(IMC), October 2019 where we exhibited Indigenous 5G Testbed Project. %Team member focussed in the design, implemention and integration of modules present in uplink receiver of physical layer in 5G cellular network.
	...
	%\item Secured All India Rank of 14475 in JEE-MAIN 2013.
...
%\begin{minipage}[t]{10cm}
%	\begin{itemize}\itemsep \isep
%		\item VLSI design laboratory
%		\item Microprocessors and microcontrollers laboratory
%\end{itemize}
%\end{minipage}
%\begin{minipage}[t]{8cm}
%	\begin{itemize}\itemsep \isep
%		\item Electronic circuits laboratory
%		\item Digital Electronics laboratory	
%\end{itemize}
%\end{minipage}\\\\[-0.3cm]
