...
\resheading{\textbf{Professional Experience (VLSI: 3 years and 10 months, Software: 1 year)}}\\[\lsep]
...
\begin{itemize}
	...
	\emph{Synopsis VCS MX, Verdi, SpyGlass for Lint, CDC and RDC  \hfill Verilog, System Verilog, Perl, Make files, Tcsh scripting, Git} \\[\spsep]
		\begin{itemize} \itemsep \isep
			...
			\item Very good team member who constantly questions the approach, provides constructive feedback to team members, keeps the workspace active and energetic with active interactions and fun events. Actively grows professional network and improves interpersonal skills.
		\end{itemize}
...
%	\end{itemize}
	...
	\begin{itemize} \itemsep \isep
		\item  Modelled big-little systolic arrays in python. Analysed the performance of various systolic array sizes. The number of compute units across rows and columns of the systolic array are varied to get different systolic arrays.
		\item 2 systolic arrays together processed the workloads. The performance for various combinations of systolic arrays in this setup is analyzed.
		%\item The idea is to maximize the utilization of the compute resources available in systolic arrays for various types of Deep Learning workloads. This idea is based on the concept of big little architectures from CPUs.
	\end{itemize}
...
\put(0.11,-0.04){\line(1,0){3.6}}\\[-0.6cm]
\begin{itemize} \itemsep  \isep
	\item Teaching assistant - Mapping signal processing algorithms to architectures \hfill \emph{January - May 2020} \\[\spsep]
	\begin{itemize} \itemsep \isep
